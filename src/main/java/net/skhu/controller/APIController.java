...
public class APIController {
	...
	public List<Student> test(@PathVariable("n") int n) {
		...
		case 2:
			...
			break;
		case 3:
			list = studentRepository.findByDepartmentName("국어국문학");
			break;
		case 4:
			list = studentRepository.findByDepartmentNameStartsWith("국어");
			break;
		case 5:
	...
	public Object testFind(@PathVariable("n") int n) {
		...
		switch (n) {
		case 1:
			list = studentRepository.find1();
			break;
		case 2:
			list = studentRepository.find2(1);
			break;
		case 3:
			list = studentRepository.find3("200032010", "고은");
			break;
		case 4:
			list = studentRepository.find4("200032010", "고은");
			break;
		case 5:
			list = studentRepository.find5();
			break;
		case 6:
			list = studentRepository.find6();
			break;
		case 7:
			list = studentRepository.find7("200032010");
			break;
		case 8:
			list = studentRepository.find8();
			break;
		case 9:
			list = studentRepository.find9();
			break;
		}
		return list;
	}
